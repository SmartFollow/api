...
class CreateTableAiClassCriterionSums extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ai_class_criterion_sums', function (Blueprint $table) {
	        $table->increments('id');
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('ai_class_criterion_sums');
